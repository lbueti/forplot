...
#' the difference between groups with 95% CI as a formatted text column (beta_format) and 
#'	as numeric variables to draw the forest (beta, beta_lci, beta_uci), and a p-value (p1)
#'
#' @format A data frame with 10 columns: \code{vlabel}, \code{n1}, \code{n2}, \code{n3}, \code{n4},
#'	\code{beta_format}, \code{beta}, \code{beta_lci}, \code{beta_uci} and \code{p1}.
#'
"forplotdata"
