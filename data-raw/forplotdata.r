...
for (i in 1:10) {
	...
	forplotdata_bp<-rbind(forplotdata_bp,
    data.frame(value=c(dat0,dat1),variable=paste0("var",i),
    arm=c(rep(1,n0),rep(2,n1))))
...
forplotdata_bp$variable<-factor(forplotdata_bp$variable,levels=paste0("var",1:10))
